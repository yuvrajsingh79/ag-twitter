...
func (s *ListsService) MembersShow(params *ListsMembersShowParams) (*users.User, *http.Response, error) {
	user := new(users.User)
	apiError := new(users.APIError)
...
func (s *ListsService) Statuses(params *ListsStatusesParams) ([]users.Tweet, *http.Response, error) {
...
func (s *ListsService) SubscribersShow(params *ListsSubscribersShowParams) (*users.User, *http.Response, error) {
	user := new(users.User)
	apiError := new(users.APIError)
