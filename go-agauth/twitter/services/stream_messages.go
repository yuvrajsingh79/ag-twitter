...
import "github.com/go-agauth/twitter/users"
...
type Event struct {
	...
	Target    *users.User `json:"target"`
	Source    *users.User `json:"source"`
	// TODO: add List or deprecate it
	TargetObject *users.Tweet `json:"target_object"`
}
