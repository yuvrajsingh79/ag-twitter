...
type DirectMessageData struct {
	...
	Entities   *users.Entities              `json:"entitites,omitempty"`
...
type DirectMessageDataAttachment struct {
	Type  string            `json:"type"`
	Media users.MediaEntity `json:"media"`
}
...
type DirectMessage struct {
	...
	Entities            *users.Entities `json:"entities"`
	ID                  int64           `json:"id"`
	IDStr               string          `json:"id_str"`
	Recipient           *users.User     `json:"recipient"`
	RecipientID         int64           `json:"recipient_id"`
	RecipientScreenName string          `json:"recipient_screen_name"`
	Sender              *users.User     `json:"sender"`
