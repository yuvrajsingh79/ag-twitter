...
func (s *TimelineService) UserTimeline(params *UserTimelineParams) ([]users.Tweet, *http.Response, error) {
	tweets := new([]users.Tweet)
...
func (s *TimelineService) HomeTimeline(params *HomeTimelineParams) ([]users.Tweet, *http.Response, error) {
	tweets := new([]users.Tweet)
	apiError := new(users.APIError)
...
func (s *TimelineService) MentionTimeline(params *MentionTimelineParams) ([]users.Tweet, *http.Response, error) {
	tweets := new([]users.Tweet)
	apiError := new(users.APIError)
...
func (s *TimelineService) RetweetsOfMeTimeline(params *RetweetsOfMeTimelineParams) ([]users.Tweet, *http.Response, error) {
	tweets := new([]users.Tweet)
	apiError := new(users.APIError)
